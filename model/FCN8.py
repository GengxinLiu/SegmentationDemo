...
def build(height, width, num_classes):
    ...
    # 2xupsample pool5(10,10,21) => (20,20,21)
    upsampled_2x_1 = Conv2DTranspose(filters=num_classes,
                                     kernel_size=(4, 4),
                                     strides=(2, 2),
                                     padding='same',
                                     use_bias=False)(score_pool5)  # 20 20 21
    score_pool4 = Conv2D(filters=num_classes,
                         kernel_size=(1, 1),
                         activation='relu',
                         padding='same',
                         name='score_pool4')(pool4)  # 20 20 21
    fuse_1 = Add()([upsampled_2x_1, score_pool4])  # 20 20 21

    # 2xupsample fuse_1(20,20,21) => (40,40,21)
    upsampled_2x_2 = Conv2DTranspose(filters=num_classes,
                                     kernel_size=(4, 4),
                                     strides=(2, 2),
                                     padding='same',
                                     use_bias=False)(fuse_1)  # 40 40 21
    score_pool3 = Conv2D(filters=num_classes,
                         kernel_size=(1, 1),
                         activation='relu',
                         padding='same',
                         name='score_pool3')(pool3)  # 40 40 21
    fuse_2 = Add()([upsampled_2x_2, score_pool3])  # 40 40 21

    # 8xupsample fuse_3(40,40,21) => (320,320,21)
    upsampled_8x = Conv2DTranspose(filters=num_classes,
                                   kernel_size=(16, 16),
                                   strides=(8, 8),
                                   padding='same',
                                   use_bias=False)(fuse_2)  # 320 320 21
    flatt = Reshape((-1, num_classes))(upsampled_8x)  # 320*320 21
